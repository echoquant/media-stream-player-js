...
import { WsRtspPlayer } from './WsRtspPlayer'
 ...
 */
export class WsRtspStreamPlayer extends HTMLElement {
  ...
  public get format() {
    return this.getAttribute('format') ?? 'RTP_H264'
  }
  ...
  public connectedCallback() {
    ReactDOM.render(
      <PlayerComponent
        ...
        subscribeAttributesChanged={(cb) => this.attributeChangeSubscriber(cb)}
        initialAttributes={{
          ...this.allAttributes,
        }}
      />,
